...
@implementation XYMiddleView
static XYMiddleView *_shareInstance;

+ (instancetype)shareInstance {
    if (_shareInstance == nil) {
        _shareInstance = [XYMiddleView middleView];
    }
...
+ (instancetype)middleView {
    ...
    XYMiddleView *middleView = [[[NSBundle mainBundle] loadNibNamed:@"XYMiddleView" owner:nil options:nil] firstObject];
    return middleView;
}
